...
import com.example.yuekaozhongjitest.load.DownloadListner;
import com.example.yuekaozhongjitest.load.DownloadManager;
    ...
    private void initDownloads() {
        ...
        mDownloadManager.add(wechatUrl, new DownloadListner() {
            ...
            public void onFinished() {
                Toast.makeText(OtherActivity.this, "下载完成!", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(OtherActivity.this,Main2Activity.class);
                intent.putExtra("sss",wechatUrl);
            ...
            @Override
            public void onPause() {
                Toast.makeText(OtherActivity.this, "暂停了!", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onCancel() {
                ...
                Toast.makeText(OtherActivity.this, "下载已取消!", Toast.LENGTH_SHORT).show();
